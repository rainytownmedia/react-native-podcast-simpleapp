...
Also, you'll need to the server running locally on your machine with the mock data. You can find the server and all the instructions to start the server [here](https://github.com/rainytownmedia/podcast-server-simple).
...
```
$ git clone https://github.com/rainytownmedia/react-native-podcast-simpleapp

$ cd react-native-podcast-simpleapp
```
...
1 - Follow the instructions on the [podcast-server](https://github.com/rainytownmedia/podcast-server-simple) to have the server up and running on your machine.

2 - With the server up and running, go to the [/.env.development](https://github.com/rainytownmedia/podcast-server-simple/blob/master/.env.development) file and edit the SERVER_URL value for the IP of your machine (you can have some issues with _localhost_ if you're running on an android physical device, but you can use localhost safely on iOS).

It should looks like this:

SERVER_URL=http://**_IP_OF_YOUR_MACHINE_**:3001/podcast/api/v1

*or*

SERVER_URL=http://localhost:3001/podcast/api/v1
